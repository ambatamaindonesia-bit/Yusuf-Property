import { HousingProject, Unit, SalesTransaction, ConstructionMilestone, FinancialRecord, AppUser, CustomerProfile, MaterialItem, MaterialUsageRecord, ProgressDocumentation, AttendanceRecord, ProspectRecord } from '../types';
...
export const INITIAL_USERS: AppUser[] = [
  ...
  },
  {
    ...
    username: 'mkt',
    password: '123',
    name: 'Tim Marketing Inhouse',
    email: 'mkt@yusufproperty.id',
    role: 'Sales Marketing',
    marketingType: 'Inhouse',
    agencyName: 'PT Yusuf Property (Inhouse)',
    phone: '081234567890',
    status: 'Aktif',
    notes: 'Akun Marketing Inhouse ERP',
    allowedTabs: ['dashboard', 'projects', 'siteplan', 'sales', 'user_data', 'prospects', 'attendance', 'kpr_calc'],
  },
  {
    id: 'usr-mkt-mgr',
    username: 'marketing',
    ...
    email: 'manager.mkt@yusufproperty.id',
    role: 'Manager Marketing',
    marketingType: '-',
    phone: '081299887766',
    status: 'Aktif',
    notes: 'Manager Tim Marketing & Leads',
    allowedTabs: ['dashboard', 'projects', 'siteplan', 'sales', 'user_data', 'prospects', 'prospect_reports', 'employees', 'attendance', 'kpr_calc', 'reports'],
  },
  {
    id: 'usr-legal',
    username: 'legal',
    password: '123',
    name: 'Legal & Sertifikat',
    email: 'legal@yusufproperty.id',
    role: 'Legal & Sertifikat',
    marketingType: '-',
    phone: '081288776655',
    status: 'Aktif',
    notes: 'Legalitas & Dokumen Sertifikat',
    allowedTabs: ['dashboard', 'projects', 'sales', 'user_data', 'prospects', 'attendance', 'reports'],
  },
];
...
export const INITIAL_PROSPECTS: ProspectRecord[] = [
  {
    ...
    phone: '081298765432',
    address: 'Jl. Melati Indah No. 45, Bintaro, Tangerang Selatan',
    source: 'Iklan Medsos',
    status: 'Berminat',
    projectNameInterest: 'Grand Yusuf Residence',
    preferredUnitType: 'Tipe 36/72 - 2 Kamar',
    agentId: 'usr-2',
    agentName: 'Rian Prasetya',
    agentRole: 'Sales Marketing',
    photoUrl: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&auto=format&fit=crop&q=80',
    locationName: 'Marketing Gallery Grand Yusuf Residence',
    locationAddress: 'Jl. Utama Proyek A (-6.2891, 106.8251)',
    coordinates: { lat: -6.2891, lng: 106.8251 },
    nextFollowUpDate: '2026-07-28',
    nextFollowUpTime: '10:00',
    nextFollowUpType: 'Janji Ketemuan Lagi',
    nextFollowUpNotes: 'Janji temu di lokasi proyek untuk pilih blok kaveling A-05 / A-06',
    followUpHistory: [
      {
        id: 'fu-1',
        date: '2026-07-25',
        time: '11:00',
        type: 'Survey Lokasi',
        notes: 'Calon pembeli lihat rumah contoh tipe 36, sangat antusias dengan row jalan 8 meter.',
        isCompleted: true,
      }
    ],
    notes: 'Incar KPR BTN Syariah DP 0%. Gaji gabungan dengan istri ~18 Juta/bulan.',
  ...
  },
  {
    ...
    phone: '081311223344',
    address: 'Komp. RS Bina Sehat No. 12, Jakarta Barat',
    source: 'Visit Lokasi Langsung',
    status: 'Minta Nego Harga',
    projectNameInterest: 'Grand Yusuf Residence',
    preferredUnitType: 'Tipe 45/90 - Hook',
    agentId: 'usr-2',
    agentName: 'Rian Prasetya',
    agentRole: 'Sales Marketing',
    photoUrl: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&auto=format&fit=crop&q=80',
    locationName: 'Lokasi Proyek Perumahan',
    locationAddress: 'Jl. Raya Ciputat No. 102 (-6.3012, 106.7410)',
    coordinates: { lat: -6.3012, lng: 106.7410 },
    nextFollowUpDate: '2026-07-27',
    nextFollowUpTime: '14:00',
    nextFollowUpType: 'Negosiasi Harga',
    nextFollowUpNotes: 'Negosiasi diskon cash bertahap 6 bulan & bonus AC 2 unit dengan Direktur',
    followUpHistory: [],
    notes: 'Minta skema pembayaran cash bertahap 12x tanpa bunga.',
  ...
  },
  {
    ...
    name: 'Ibu Ratna Sari',
    phone: '085788990011',
    address: 'Jl. Kebon Jeruk Asri B-3, Jakarta',
    source: 'Referensi',
    sourceReferenceDetail: 'Ref dari Pak Heru (Konsumen Blok A-01)',
    status: 'Proses KPR / Pemberkasan',
    projectNameInterest: 'Yusuf Royal Heights',
    preferredUnitType: 'Tipe 60/100 2 Lantai',
    agentId: 'usr-2',
    agentName: 'Rian Prasetya',
    agentRole: 'Sales Marketing',
    photoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&auto=format&fit=crop&q=80',
    locationName: 'Kantor Bank Mandiri Cabang Bintaro',
    locationAddress: 'Jl. Boulevard Bintaro Sektor 7 (-6.2750, 106.7210)',
    nextFollowUpDate: '2026-07-29',
    nextFollowUpTime: '09:30',
    nextFollowUpType: 'Telepon / WA Follow Up',
    nextFollowUpNotes: 'Cek kelengkapan slip gaji & mutasi rekening 3 bulan terakhir',
    notes: 'Rekomendasi tetangga, siap booking kavling pekan ini jika syarat KPR disetujui.',
  ...
  },
  {
    ...
    name: 'Siti Aminah',
    phone: '082144556677',
    address: 'Jl. Anggrek No. 18, Depok',
    source: 'Sebar Brosur',
    status: 'Cuma Tanya-tanya',
    projectNameInterest: 'Grand Yusuf Residence',
    preferredUnitType: 'Tipe 36/72',
    agentId: 'usr-1',
    agentName: 'Yusuf Admin ERP',
    agentRole: 'Super Admin',
    photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&auto=format&fit=crop&q=80',
    locationName: 'Pameran Mall Mall Bintaro Xchange',
    locationAddress: 'Stand Pameran Developer Yusuf Property (-6.2731, 106.7265)',
    nextFollowUpDate: '2026-08-01',
    nextFollowUpType: 'Telepon / WA Follow Up',
    nextFollowUpNotes: 'Kirim e-brochure & price list terbaru via WhatsApp',
    notes: 'Rencana beli untuk investasi sewa. Masih membandingkan dengan perumahan lain.',
